        ...
        <div id="collapsestock" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Operation des Stock</h6>
                        ...
                        <a class="collapse-item" href="../achat/liste.php?date=2025">Stock Achat </a>
        ...
        <div id="dette" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Dette:</h6>
                            ...
                            <a class="collapse-item" href="../dette/dette.php?date=2025">Liste credit</a>
        ...
        <div id="utilisateur" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                '
                        ...
                        <a class="collapse-item" href="../userCon/liste.php?date=2025">Liste</a>
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Utilities:</h6>
                        ...
                        <a class="collapse-item" href="../caisse/liste.php?date=2025">liste caisse</a>
                        <a class="collapse-item" href="../depenses/depense.php?date=2025">Depenses</a>
                        <a class="collapse-item" href="../depenses/liste.php?date=2025">Liste Depense</a>
