            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php 
                    if (($_SESSION["route"] == "cabinet")) {
                        ...
                        <a class="collapse-item" href="php/vente/liste.php?date=2025">liste vente</a>
                        ';
                    }
                ?>
                ...
                <?php 
                    if (($_SESSION["route"] == "cabinet")) {
                      ...
                      echo '
                        ...
                        <a class="collapse-item" href="php/achat/liste.php?date=2025">liste Achat</a>
                      ';   
                    }
                ?>
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php 
                    if (($_SESSION["route"] == "cabinet")) {
                        ...
                        echo '
                            <a class="collapse-item" href="php/stock/sctockVente.php?date=2025">Historique </a>
                            <a class="collapse-item" href="php/achat/liste.php?date=2025">Stock Achat </a>
                            <a class="collapse-item" href="php/stock/recaptliste.php?date=2025">Recapitulatif</a>
                ...
                <?php 
                    if (($_SESSION["route"] == "cabinet")) {
                        ...
                        echo '
                            ...
                            <a class="collapse-item" href="php/versement/liste.php?date=2025">Liste versement</a>
                        ';
                    }
                ?>
        ...
        <div id="dette" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            ...
            <?php 
                    if (($_SESSION["route"] == "cabinet")) {
                        ...
                        echo '
                            <a class="collapse-item" href="php/dette/dette.php?date=2025">Liste credit</a>
                        ';
                    }
                ?>
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php 
                    if (($_SESSION["route"] == "cabinet")) {
                        ...
                        <a class="collapse-item" href="php/caisse/liste.php?date=2025">liste caisse</a>
                        ';
                    }
                ?>
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php 
                    if (($_SESSION["route"] == "cabinet")) {
                        ...
                        <a class="collapse-item" href="php/depenses/liste.php?date=2025">Liste Depense</a>
                        ';
                    }
                ?>
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php 
                    if (($_SESSION["route"] == "cabinet")) {
                        ...
                        echo '
                        <a class="collapse-item" href="php/dette/dette.php?date=2025">Liste dette</a>
                        ';
                    }
                ?>
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php 
                    if (($_SESSION["route"] == "cabinet")) {
                        ...
                        echo '
                        <a class="collapse-item" href="php/caise/liste.php?date=2025">liste caisse</a>
                        <a class="collapse-item" href="php/depenses/liste.php?date=2025">Liste Depense</a>
                        ';
                    }
                ?>
