        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">CHIFFRE AFFAIRES</h1>
                        ...
                        <div class="row">
                            ...
                            <p class="col-md-2" >
                                <button class="btn btn-info btn-user btn-block" onclick="Cfhiffreafaire()">Affichier anne</button>
                            </p>
                        </div>
                                ...
                                <div class="card shadow mb-1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card shadow mb-1">
                                                <div class="card-header py-3">
                                                    <h7 class="m-0 font-weight-bold text-primary">Travaux, services vendus :</h7>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card shadow mb-1">
                                                <div class="card-header py-3">
                                                    <h7 class="m-0 font-weight-bold text-primary">Produits accessoires :</h7>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                    
                                                        <span id="accesoire"> </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
