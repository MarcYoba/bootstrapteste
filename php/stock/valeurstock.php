                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="form-group row">
                                <div class="col-sm-6">
                                <h6 class="m-0 font-weight-bold text-primary">Valeur en Stock</h6>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" data-page-length='25' data-order='[[0, "desc"]]'>
                                    ...
                                    <?php 
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)){
                                            ...
                                            $sql3 = "SELECT ROUND(SUM(quantite), 2) as total FROM achat WHERE  idproduit  = '$id' AND YEAR(dateachat) = '$date'";
                                            ...
                                            $sql3 = "SELECT ROUND(SUM(quantite), 2) as total FROM facture WHERE  idproduit  = '$id' AND YEAR(datefacture) = '$date'";
                                            $result3 = $conn->query($sql3);
                                            ...
                                            $sql4 = "SELECT ROUND(SUM(quantite),2) as quantite,ROUND(SUM(montant),2) as montant,Nomproduit  FROM achat WHERE YEAR(dateachat) = '$date' AND idproduit = '$id'";
