...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="annul" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="php/graphe/getannul.php">Graphe Annul</a> 
                    </div>
                </div>
            </li>
            <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Rapport annul</h1>
    ...
    <script src="../../js/demo/chart-bar-annul-moi.js"></script>
