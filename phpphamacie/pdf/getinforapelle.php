...
$html .='<br><br><br> <table style="width:100%">
        <thead>';
        $html .=' <tr><th colspan="5" align="center">Produit sans date peremtion </th></tr>
        </thead>
        <tbody>';
        $html .= '<tr>';
        ...
        $html .= '</tr>
            ...
            <th scope="col">lot 01 </th>
            <th scope="col">lot 02 </th>
            
        </tr>';
            $nbperemption = $produit->ProduitSansDatePremption();
    ...
    $html .='<br><br><br> <table style="width:100%">
        <thead>';
        $html .=' <tr><th colspan="2" align="center">Doublon de produit </th></tr>
        </thead>
        <tbody>';
        $html .= '<tr>';
        ...
        $html .= '</tr>
            ...
            $nbperemption = $produit->DoublonProduit();
            foreach ($nbperemption as $linefatcture) {
                $html .= '<tr>';
                foreach ($linefatcture as $key => $cell) {
                    $html .= '<td>' .$cell.'</td>';
