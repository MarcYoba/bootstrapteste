...
$html .='<br><br><br> <table style="width:100%">
        <thead>';
        $html .=' <tr><th colspan="3" align="center">Somme vente part Mois : '.date("Y").'</th></tr>
        </thead>
        <tbody>';
        $html .= '<tr>';
        ...
        $historique = $vente->VenteAnnuelle($anne);
    ...
    $html .='<br><br><br> <table style="width:100%">
        <thead>';
        $html .=' <tr><th colspan="3" align="center">Somme vente par Semaine : '.date("Y").'</th></tr>
        </thead>
        <tbody>';
        $html .= '<tr>';
        ...
        $historique = $vente->VenteAnnuelleSemain($anne);
            foreach ($historique as $linefatcture) {
                $html .= '<tr>';
                foreach ($linefatcture as $key => $cell) {
                    $html .= '<th>' .$cell.'</th>';
