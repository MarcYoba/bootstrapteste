                            ...
                            <form class="user" action="register.php" method="post" >
                                ...
                                <?php 
                                    ...
                                    echo '<div class="form-group row">';
                                        ...
                                        echo '<select id="description"  name="description"  class="form-control form-select" required>';
                                        if(isset($_GET['tableau'])){
                                            $tabdonne = $_GET['tableau'];
                                           $donnees= json_decode($tabdonne,true);
                                        ...
                                        echo'</div>'; 
                                            echo'<div class="col-sm-6 mb-3 mb-sm-0">';
                                                ...
                                                $donnees= json_decode($tabdonne,true);
                                                    ...
                                                    name="motif" placeholder="Motif du mouvement" value="'.$donnees["motif"].'" required>';
                                                    
                                                }else{
                                                    echo'<input type="text" class="form-control form-control-user" id="description"
                                                    name="motif" placeholder="Motif du mouvement"  required>';
                                                }
                                            echo'</div>';
                                        echo'</div>';
                                        echo'<div class="form-group row">';
